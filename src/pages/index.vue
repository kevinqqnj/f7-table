<template>
    <f7-page>
        <f7-navbar>
            <div class="title">Framework7 Table Components</div>
        </f7-navbar>
        ...
        <f7-list>
            ...
            <f7-list-item link="">
                            ...
                            <f7-link href="https://github.com/kevinqqnj/f7-table" target="_blank" external class="item-link">
                                Github <i class="fas fa-link fa-xs" color="" /></f7-link>
                        </f7-list-item>
        </f7-list>
    </f7-page>
</template>
